...
/**
 * Example demonstrating unsafe expressions !{ }
 * 
 * Safe mode {expr} - property access only
 * Unsafe mode !{expr} - full JavaScript expressions
 */
class UnsafeExpressions extends Component(HTMLElement) {
  static tag = 'unsafe-expressions';
    ...
    return html`
      <div class="card">
        ...
        <p style="color: #666; margin-bottom: 20px;">
          Exclamation mark with curly braces enables full JavaScript in templates
        </p>
        ...
        <section style="background: #f5f5f5; padding: 15px; border-radius: 6px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 8px;">Unsafe</td>
...
customElements.define(UnsafeExpressions.tag, UnsafeExpressions);
