...
export default class TodoFooter extends Component(HTMLElement) {
  ...
  constructor() {
    super();
    // Properties will be set via :prop binding
    // Default values
  ...
  render() {
    return html`
      <footer class="footer">
        ...
        <button class="clear-completed" onclick="{handleClearCompleted}" hidden="{this.hideCompletedButton}">Clear completed</button>
      </footer>
    `;
  }
}
